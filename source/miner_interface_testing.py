...
order_book = [[True, 10000000, 0, 1000000000000000000],
            ...
            [False, 10000000, 0, 1000000000000000000],
            [True, 1000000, 0, 1000000000000000050],
            [False, 10000, 0, 900000000000000000],
            [False, 100000, 0, 1000000000000000045],
            [False, 1000000, 0, 909000000000000000],
            [True, 10000, 0, 1000000000000000000],
            [True, 100000, 0, 1000000000000000000],
            [True, 100000, 0, 1000000000000000050],
            [False, 100000, 0, 900000000000000000],
            [True, 100000, 0, 1000000000000000045],
            [True, 100000, 0, 909000000000000000]]
